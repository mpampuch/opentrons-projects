def get_values(*names):
    import json
    _all_values = json.loads("""{"input_csv":"concentration (in ng/ul)\\n10\\n8\\n11\\n","target_dna_volume":9,"p20_mount":"right","p1000_mount":"left","source_type":"opentrons_24_tuberack_eppendorf_1.5ml_safelock_snapcap","dest_type":"biorad_96_wellplate_200ul_pcr","reagent_type":"opentrons_24_tuberack_eppendorf_1.5ml_safelock_snapcap","barcode_well":"biorad_96_wellplate_200ul_pcr"}""")
