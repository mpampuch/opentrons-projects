def get_values(*names):
    import json
    _all_values = json.loads("""{"num_samples":96,"lw_deepwell_plate":"eppendorf_96_wellplate_1000ul","starting_vol":200,"mixreps":15,"time_settling_minutes":2,"time_airdry_minutes":15,"vol_final_elution":35}""")
